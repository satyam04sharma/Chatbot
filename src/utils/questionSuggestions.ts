...
Keep the answer to provide 3 short, context-specific questions in a numbered list. Each question should be no longer than 15 words and dont use rich text markdown, just give these suggestions in plain text.`;
